...
import styles from './SelectedCity.module.css'; // Assuming you have a CSS file for styling
  ...
  return (
    <div className={styles["selected-city-container"]} id='selected-city-container'>
      ...
      <div className={styles["selected-city-header"]} id='selected-city-header'>
        ...
        <div className={styles["selected-city-desc"]} id='selected-city-desc'>
      ...
      <div className={styles["selected-city-best-time-to-visit"]} id='selected-city-best-time-to-visit'>
        <h1>Best Time to Visit Bhopal</h1>
        <p>All year round destination</p>
        <div className={styles["selected-city-best-time-to-visit-Season"]} id='selected-city-best-time-to-visit-Season-weather'>
          <div className={styles["selected-city-best-time-to-visit-Season"]} id='selected-city-best-time-to-visit-Season'>
      ...
      <div className={styles["selected-city-attractions-section"]} id='selected-city-attractions-section'>
        <h1>Attractions</h1>
        <div className={styles["selected-city-attractions"]} id='selected-city-attractions'></div>
      </div>

      {/* Hotels in that city */}
      <div className={styles["selected-city-hotels-section"]} id='selected-city-hotels-section'>
        <h1>Stay in Bhopal</h1>
        <p>Recommended Options</p>
        <div className={styles["selected-city-hotels"]} id='selected-city-hotels'></div>
      </div>
      ...
      <div className={styles["selected-city-overview"]} id='selected-city-overview'>
        ...
        <div className={styles["selected-city-name-title-history-card"]} id='selected-city-name-title-history-card'>
      ...
      <div className={styles["selected-city-how-to-reach"]} id='selected-city-how-to-reach'>
        <div className={styles["selected-city-transport-map"]} id='selected-city-transport-map'>
          ...
          <h1>How to Reach Goa</h1>
            <div className={styles['by-air']} id='by-air'>
              <h2>By Air</h2>
            ...
            <div className={styles['by-train']} id='by-train'>
              <h2>By Rail</h2>
            ...
            <div className={styles['by-road']} id='by-road'>
              <h2>By Road</h2>
      ...
      <div className={styles["selected-city-food-to-try"]} id='selected-city-food-to-try'>
      ...
      {/* Famous Restaurants  */}
      <div className={styles["selected-city-famous-restaurants"]} id='selected-city-famous-restaurants'>
        <h2>Famous Restaurants in Bhopal</h2>
        <div className={styles["restaurants-list"]} id='restaurants-list'>
      ...
      <div className={styles["selected-city-famous-hotels"]} id='selected-city-famous-hotels'>
        ...
        <div className={styles["hotels-list"]} id='hotels-list'>
      ...
      <div className={styles["selected-city-things-to-buy"]} id='selected-city-things-to-buy'>
        <h2>Things to Buy in Bhopal</h2>
        <div className={styles["things-to-buy"]} id='things-to-buy'>
          <h2>Chowk Bazaar</h2>
      ...
      {/* Conclusion */}
      <div className={styles["selected-city-Conclusion"]} id='selected-city-Conclusion'>
        <h2>Conclusion</h2>
