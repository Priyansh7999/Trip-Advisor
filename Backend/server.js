...
const cities = [
  {'id': 1,
   ...
   {'id': 2,
    'title': 'Noida',
    'State': 'Uttar Pradesh',
    'src': 'https://t4.ftcdn.net/jpg/05/40/30/71/360_F_540307170_qg8R8Seug9NYJzL7FpbBuW5St0lIyAvv.jpg',
    'des': "Noida short for New Okhla Industrial Development Authority located in UP",
...
app.get('/train-data', async (req, res) => {
    ...
    try {
        const trains = await scrapeTrainData(from, to);
        res.json(trains);
    } catch (error) {
