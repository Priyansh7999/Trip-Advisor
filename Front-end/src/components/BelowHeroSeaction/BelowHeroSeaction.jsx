...
import styles from "./BelowHeroSeaction.module.css"

export default function BelowHeroSeaction() {
  return (
    <div>
      <div className={styles["below-hero-section"]} id="below-hero-section">
            ...
            <button className={styles["explore-but"]} id="explore-but" onClick={() => window.location.href = "#Search"}>Let's Explore</button>      
          </div>
    </div>
  )
}
