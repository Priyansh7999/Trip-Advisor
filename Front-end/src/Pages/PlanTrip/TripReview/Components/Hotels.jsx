...
export default function Hotels({ latitude, longitude }) {
      ...
      const fetchRestaurants = async () => {
        try {
          const response = await fetch(
            `https://maps-data.p.rapidapi.com/nearby.php?query=hotel&lat=${latitude}&lng=${longitude}&limit=50&country=us&lang=en&offset=0&zoom=1`,
            {
              method: 'GET',
              headers: {
